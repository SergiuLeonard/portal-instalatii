...
export default function ProiecteEuropenePage() {
  ...
  return (
    <main className="min-h-screen bg-[#0a0a0b] text-white">
      {/* Header cu Gradient European */}
<div className="relative overflow-hidden border-b border-gray-800">
  {/* Background gradient - tematică UE (blue-yellow) */}
  <div className="absolute inset-0 bg-gradient-to-br from-blue-900/90 via-gray-900 to-yellow-900/30" />
  
  {/* Cercuri decorative */}
  <div className="absolute top-0 right-0 w-96 h-96 bg-yellow-500/10 rounded-full blur-3xl transform translate-x-1/3 -translate-y-1/3" />
  ...
  <div className="relative max-w-6xl mx-auto px-4 py-12">
    <div className="flex items-center gap-4 mb-3">
      ...
      <div>
        ...
        <p className="text-blue-200/90 text-lg max-w-2xl">
          Ghid simplificat pentru accesarea fondurilor europene în domeniul construcțiilor și instalațiilor
        </p>
        <p className="text-yellow-200/60 text-sm mt-1 italic">
          Fără să te pierzi în birocrație
        </p>
      </div>
    </div>
  </div>
